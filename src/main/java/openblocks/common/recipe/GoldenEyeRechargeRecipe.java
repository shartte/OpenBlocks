...
public class GoldenEyeRechargeRecipe extends ShapelessOreRecipe {
	...
	public GoldenEyeRechargeRecipe() {
		super(new ItemStack(Items.goldenEye, 1, ItemGoldenEye.MAX_DAMAGE - PEARL_RECHARGE), new ItemStack(Items.goldenEye, 1, ItemGoldenEye.MAX_DAMAGE), net.minecraft.init.Items.ender_pearl);
	}
